...
const GraphDashboard = ({ title, icon, data, color }) => (
  <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 4, px: "20px" }}>
    <Stack
      gap={1}
      sx={{
        p: "20px",
    ...
    >
      <Stack flexDirection="row" gap={1} alignSelf="flex-start">
        <AttachMoney />
        <Typography fontWeight={600} sx={{ textOverflow: "ellipsis" }}>
          Depreciation
        </Typography>
      </Stack>
  ...
  return (
    <Box className="mcontainer">
      ...
      <Box className="dashboard__main-content">
        <Box className="dashboard__header" sx={{ mt: "20px" }}>
          <Box>
            <Typography
              sx={{
